...
router.post("/create", isAuthenticated, upload.single("product_image"), productController.createProduct); 


router.get("/:productId/edit", isAuthenticated, productController.showEditForm); 
router.post("/:productId/edit", isAuthenticated, upload.single("product_image"), productController.editProduct); 
